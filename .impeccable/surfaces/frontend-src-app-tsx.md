...
related_targets: ["frontend/src/components/Dashboard.tsx","frontend/src/components/AuthScreens.tsx","frontend/src/components/KiScreen.tsx"]
---
...
- Primary action: adjust the plan without silently wiping logged choices or replacing completed work.
...
| Primary action | PLAN ANPASSEN as a wide clipped cyan control with restrained inner light | Semantic button + CSS clip-path; no rasterized text |
