...
export const SAFE_SUPPLEMENT_CATALOG: readonly SafeSupplementCatalogItem[] = [
  ...
  },
  {
    ...
    purpose: 'A convenience product for essential amino acids when adequate protein foods are difficult to reach.',
    phase: 'beta',
    timingLabel: 'Total daily protein remains the first reference point',
    guidance: 'Use the product label and review the complete food pattern before adding another protein-derived product.',
    caution: 'Added benefit is uncertain when total high-quality protein intake is already adequate.',
    whatItIs: 'A mixture of amino acids the body cannot make and must obtain from food.',
    supportedUse: 'Essential amino acids are required for normal protein synthesis, but ordinary protein foods already provide them.',
    evidenceLimits: 'Evidence does not show a reliable performance advantage over enough complete dietary protein for most users.',
    evidenceLevel: 'food_first',
    foodSources: ['Dairy, eggs, fish, meat, or poultry', 'Soy foods', 'Complementary legumes and grains'],
    cautions: ['Check allergens and overlapping protein products.', 'Use qualified advice for kidney disease, pregnancy, or clinical nutrition needs.'],
    interactionPrompt: 'Does your current food and protein intake already provide enough complete protein?',
    sources: [PERFORMANCE_SOURCE],
    reviewedAt: REVIEWED_AT,
  },
  {
    id: 'zinc',
    label: 'Zinc',
    purpose: 'An essential mineral; food and an identified individual need come before supplementation.',
    phase: 'gamma',
    timingLabel: 'No character or training goal establishes a need',
    guidance: 'Use the product label and ask a qualified clinician or pharmacist about need and interactions.',
    caution: 'Excess zinc can be harmful and can interfere with copper status and medicines.',
    whatItIs: 'An essential mineral involved in many normal cellular and immune processes.',
    supportedUse: 'Adequate zinc intake supports normal body functions; supplementation can correct inadequate intake when appropriately identified.',
    evidenceLimits: 'A lean physique, hard training, or a character path does not diagnose deficiency.',
    evidenceLevel: 'food_first',
    foodSources: ['Oysters and other seafood', 'Meat, poultry, eggs, and dairy', 'Beans, nuts, and fortified cereals'],
    cautions: ['Review antibiotics, penicillamine, and overlapping multivitamins.', 'Long-term excess can cause clinically important harm.'],
    interactionPrompt: 'Has your total intake, medicine list, and individual need been reviewed?',
    sources: [{
      label: 'Zinc — Consumer',
      authority: 'NIH Office of Dietary Supplements',
  ...
  },
  {
    id: 'mass-gainer',
    label: 'Mass gainer',
    purpose: 'A calorie-dense food product that may make a deliberately planned energy surplus more convenient.',
    phase: 'beta',
    timingLabel: 'Use only within a complete food and energy plan',
    guidance: 'Compare the label with regular meals, allergens, added sugar, and your actual energy needs.',
    caution: 'It is not required for hypertrophy and can add more energy or sugar than intended.',
    whatItIs: 'A powdered mixture usually combining carbohydrate, protein, flavoring, and other ingredients.',
    supportedUse: 'Energy and protein support body-mass gain when training and total intake are appropriate; a powder is one optional way to supply them.',
    evidenceLimits: 'A branded gainer is not inherently better than regular calorie-dense meals or a simple homemade shake.',
    evidenceLevel: 'food_first',
    foodSources: ['Milk or fortified alternatives with oats and nut butter', 'Rice, potatoes, pasta, legumes, dairy, eggs, fish, or meat', 'Nuts, seeds, avocado, and oils within balanced meals'],
    cautions: ['Check allergens, added sugars, and overlapping stimulants or creatine.', 'Use qualified advice for diabetes, digestive conditions, eating-disorder recovery, or clinical nutrition needs.'],
    interactionPrompt: 'Is a planned energy surplus appropriate for you, and have you checked the complete ingredient list?',
    sources: [PERFORMANCE_SOURCE],
    reviewedAt: REVIEWED_AT,
  },
  {
    ...
    purpose: 'Some adult users may experience a short-term performance or perceived-effort benefit from caffeine.',
    phase: 'alpha',
    timingLabel: 'Sleep, total caffeine, medicines, and personal sensitivity matter',
    guidance: 'Read the full label, count caffeine from every source, and seek individual advice when unsure.',
    caution: 'Products can combine multiple stimulants. CORELINE does not recommend a dose or treat a stronger product as better.',
    whatItIs: 'A broad product category that may contain caffeine plus many other ingredients in varying amounts.',
    supportedUse: 'Caffeine can improve some aspects of performance for some adults, with substantial individual variation.',
    evidenceLimits: 'Benefits are not universal; sleep disruption, anxiety, palpitations, and other adverse effects can outweigh them.',
    evidenceLevel: 'context_dependent',
    foodSources: ['Coffee or tea when appropriate', 'Food and hydration before training'],
    cautions: ['Avoid casual use by children and teenagers.', 'Review pregnancy, heart rhythm concerns, anxiety, sleep problems, medicines, and other caffeine sources with a qualified professional.'],
    interactionPrompt: 'How much caffeine do you already use, and do sleep, medicines, pregnancy, or heart symptoms require review?',
    sources: [PERFORMANCE_SOURCE, {
      label: 'Spilling the Beans: How Much Caffeine is Too Much?',
...
const GERMAN_SUPPLEMENT_COPY: Record<string, SupplementTranslation> = {
  ...
  eaa: {
    label: 'Essenzielle Aminosäuren',
    purpose: 'Eine praktische EAA-Option, wenn ausreichende Proteinquellen über Lebensmittel schwer erreichbar sind.',
    timingLabel: 'Die gesamte tägliche Proteinzufuhr bleibt der erste Bezugspunkt',
    guidance: 'Beachte das Produktetikett und prüfe zuerst die gesamte Ernährung, bevor du ein weiteres Proteinprodukt ergänzt.',
    caution: 'Bei bereits ausreichender Zufuhr hochwertigen Proteins ist ein zusätzlicher Nutzen unsicher.',
    whatItIs: 'Eine Mischung aus Aminosäuren, die der Körper nicht selbst herstellen kann und aus Nahrung erhalten muss.',
    supportedUse: 'Essenzielle Aminosäuren sind für normale Proteinsynthese nötig; normale Proteinlebensmittel liefern sie bereits.',
    evidenceLimits: 'Für die meisten Menschen ist gegenüber ausreichend vollständigem Nahrungsprotein kein verlässlicher Leistungsvorteil belegt.',
    foodSources: ['Milchprodukte, Eier, Fisch, Fleisch oder Geflügel', 'Sojaprodukte', 'Kombinationen aus Hülsenfrüchten und Getreide'],
    cautions: ['Prüfe Allergene und überlappende Proteinprodukte.', 'Bei Nierenerkrankung, Schwangerschaft oder klinischer Ernährung ist qualifizierte Beratung nötig.'],
    interactionPrompt: 'Liefert deine aktuelle Ernährung bereits ausreichend vollständiges Protein?',
  },
  zinc: {
    label: 'Zink',
    purpose: 'Ein essenzieller Mineralstoff; Lebensmittel und ein festgestellter individueller Bedarf gehen vor.',
    timingLabel: 'Weder Charakter noch Trainingsziel begründen einen Bedarf',
    guidance: 'Beachte das Etikett und kläre Bedarf und Wechselwirkungen mit einer qualifizierten Fachperson.',
    caution: 'Zu viel Zink kann schaden und Kupferstatus sowie Medikamente beeinflussen.',
    whatItIs: 'Ein essenzieller Mineralstoff, der an vielen normalen Zell- und Immunprozessen beteiligt ist.',
    supportedUse: 'Eine ausreichende Zinkzufuhr unterstützt normale Körperfunktionen; bei passend festgestellter Unterversorgung kann Ergänzung sinnvoll sein.',
    evidenceLimits: 'Ein schlanker Körperbau, hartes Training oder ein Charakter-Pfad diagnostizieren keinen Mangel.',
    foodSources: ['Austern und andere Meeresfrüchte', 'Fleisch, Geflügel, Eier und Milchprodukte', 'Bohnen, Nüsse und angereicherte Cerealien'],
    cautions: ['Prüfe Antibiotika, Penicillamin und überlappende Multivitamine.', 'Langfristige Überdosierung kann klinisch relevante Schäden verursachen.'],
    interactionPrompt: 'Wurden Gesamtzufuhr, Medikamente und individueller Bedarf geprüft?',
  },
  'mass-gainer': {
    label: 'Mass-Gainer',
    purpose: 'Ein kalorienreiches Lebensmittelprodukt, das einen bewusst geplanten Energieüberschuss praktischer machen kann.',
    timingLabel: 'Nur im Rahmen eines vollständigen Ernährungs- und Energieplans verwenden',
    guidance: 'Vergleiche das Etikett mit normalen Mahlzeiten, Allergenen, zugesetztem Zucker und deinem tatsächlichen Energiebedarf.',
    caution: 'Für Hypertrophie nicht erforderlich und kann mehr Energie oder Zucker liefern als beabsichtigt.',
    whatItIs: 'Eine Pulvermischung meist aus Kohlenhydraten, Protein, Aromen und weiteren Zutaten.',
    supportedUse: 'Energie und Protein unterstützen Gewichtszunahme, wenn Training und Gesamtzufuhr passen; Pulver ist nur eine optionale Form.',
    evidenceLimits: 'Ein Marken-Gainer ist normalen kalorienreichen Mahlzeiten oder einem einfachen selbstgemachten Shake nicht grundsätzlich überlegen.',
    foodSources: ['Milch oder angereicherte Alternative mit Hafer und Nussmus', 'Reis, Kartoffeln, Nudeln, Hülsenfrüchte und Proteinlebensmittel', 'Nüsse, Samen, Avocado und Öle in ausgewogenen Mahlzeiten'],
    cautions: ['Prüfe Allergene, zugesetzten Zucker und überlappendes Kreatin oder Stimulanzien.', 'Bei Diabetes, Verdauungserkrankung, Essstörungserholung oder klinischer Ernährung ist qualifizierte Beratung nötig.'],
    interactionPrompt: 'Ist ein geplanter Energieüberschuss für dich passend und hast du alle Zutaten geprüft?',
  },
  preworkout: {
    label: 'Pre-Workout / Koffein',
    purpose: 'Manche Erwachsene können kurzfristig bei Leistung oder wahrgenommener Anstrengung von Koffein profitieren.',
    timingLabel: 'Schlaf, Gesamtkoffein, Medikamente und individuelle Empfindlichkeit zählen',
    guidance: 'Lies das vollständige Etikett, zähle Koffein aus allen Quellen und hole bei Unsicherheit individuelle Beratung ein.',
    caution: 'Produkte können mehrere Stimulanzien kombinieren. CORELINE empfiehlt keine Dosierung und setzt stärker nicht mit besser gleich.',
    whatItIs: 'Eine breite Produktkategorie, die Koffein und viele weitere Zutaten in wechselnden Mengen enthalten kann.',
    supportedUse: 'Koffein kann bei manchen Erwachsenen bestimmte Leistungsaspekte verbessern; die Reaktion unterscheidet sich deutlich.',
    evidenceLimits: 'Der Nutzen ist nicht universell; Schlafprobleme, Angst, Herzklopfen und andere Nebenwirkungen können überwiegen.',
    foodSources: ['Kaffee oder Tee, wenn passend', 'Mahlzeit und Flüssigkeit vor dem Training'],
    cautions: ['Nicht beiläufig für Kinder oder Jugendliche einsetzen.', 'Schwangerschaft, Herzrhythmus, Angst, Schlaf, Medikamente und andere Koffeinquellen fachlich prüfen.'],
    interactionPrompt: 'Wie viel Koffein nutzt du bereits und müssen Schlaf, Medikamente, Schwangerschaft oder Herzsymptome geprüft werden?',
  },
};
